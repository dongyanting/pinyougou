...
<div class="py-container">
    <div id="item">
        ...
        <div class="product-info">
			...
			<#--[{"text":"内存大小","value":"最大可扩展到512G"},{"text":"颜色","value":"五颜六色任君选择"}]-->
                    ...
                    <div id="specification" class="summary-wrap clearfix">
							<#list specificationItems as spec>
								...
								<#list spec.attributeValue as value>
								 <dd ng-click="updateSpec('${spec.attributeName}','${value}')"><a class="{{ifSelected('${spec.attributeName}','${value}')?'selected':''}}" href="javascript:;">${value}</a></dd>
								</#list>
                                </dl>
							</#list>
                    </div>
